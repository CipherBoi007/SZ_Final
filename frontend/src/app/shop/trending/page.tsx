    ...
    <div className="min-h-screen pt-24 lg:pt-28 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          ...
          <h1 className="mt-3 text-3xl sm:text-4xl font-bold gradient-text">Trending</h1>
          <p className="mt-3 text-white/40 max-w-md mx-auto">See what everyone&apos;s loving right now</p>
        </motion.div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <p className="text-white/30 text-lg">No trending products right now</p>
                ...
                <motion.div key={product.id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}>
                  <Link href={`/shop/${product.id}`} className="group block rounded-2xl overflow-hidden glass glass-hover">
                    <div className="relative aspect-[3/4] overflow-hidden">
                      ...
                      <span className="absolute top-3 left-3 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-accent/80 text-white backdrop-blur-sm flex items-center gap-1">
