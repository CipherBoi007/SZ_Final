      ...
      <div className="flex-1 flex items-center justify-center p-6 pt-28 lg:p-16 lg:pt-32 bg-background">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="w-full max-w-md">
          ...
          <button 
            ...
            className="mt-6 w-full flex items-center justify-center gap-3 py-3.5 rounded-xl border border-white/10 hover:bg-white/5 text-sm text-white/70 hover:text-white transition-colors"
          >
            Sign in with OTP
          </button>
          ...
          <button 
            ...
            className="mt-4 w-full flex items-center justify-center gap-3 py-3.5 rounded-xl glass glass-hover text-sm text-white/70 hover:text-white transition-colors"
          >
