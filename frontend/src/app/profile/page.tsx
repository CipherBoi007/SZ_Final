...
export default function ProfilePage() {
  ...
  const handleChangePassword = async (e: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      await authAPI.updatePassword({ currentPassword: currentPass, newPassword: newPass });
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            ...
                            {isEditing ? (
                              ...
                              <div className="w-full py-3.5 pl-11 pr-4 rounded-xl bg-white/[0.02] border border-transparent text-sm text-white/80">
                                {name || 'Not set'}
                              </div>
                            )}
                          </div>
                      ...
                      {isEditing && (
                        <div className="pt-4 border-t border-white/5 flex justify-end gap-3">
                          <button 
                            ...
                            className="px-6 py-3.5 rounded-xl bg-white/5 text-white text-sm font-bold hover:bg-white/10 transition-all"
                          >
                            Cancel
                          </button>
