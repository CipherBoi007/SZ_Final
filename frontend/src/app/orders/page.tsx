...
import { Package, ChevronRight, ChevronLeft, Clock, Truck, CheckCircle2, XCircle, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen pt-24 lg:pt-28 pb-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <Link href="/profile" className="inline-flex items-center gap-2 text-xs text-white/30 hover:text-white transition-colors mb-6 group">
